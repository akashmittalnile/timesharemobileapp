...
const BlugreenContract = ({navigation, route}) => {
  ...
  return (
      ...
      <View style={styles.container}>
        ...
        /> */}
            ...
            <View style={[styles.textViewContainer, { marginTop: 10 }]}>
              <View
                style={[styles.circle, { backgroundColor: "#353334" }]}
              ></View>
              <MyText
                text={
          ...
          >
            ...
            <View style={[styles.textViewContainer, { marginTop: 10 }]}>
              ...
              <MyText
                text={
                  "Once your account has been started, we will send you a payment according to how many points we used on reservation that has checked in."
                }
                textColor="#ffff"
                fontSize={13}
                fontFamily="Verdana"
            ...
            <View style={[styles.textViewContainer, { marginTop: 10 }]}>
              ...
              <MyText
                text={
                  "We will use your account until all the agreedupon points are monetized to as close to that number as possible.(sometimes there might be a small remainder of points left.)"
                }
                textColor="#ffff"
                fontSize={13}
                fontFamily="Verdana"
         ...
         <View>
           ...
           <View>
                  ...
                  <MyText
                    text={
                      'WHEREAS, Program Member owns a number of points in the Bluegreen Vacation Club ("BVC") timeshare program and desires to engage TS to act as its designated Delate to operate PM’s timeshare program for the purposes including but not limited to, arranging, coordinating and identifying Guests to utilize PM’s BVC points; and'
                    }
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
          ...
          <View style={{ backgroundColor: "#F0DFCF" }}>
            ...
            />
            <Image
              style={{ height: 232, width: 390 }}
              source={images.ftbanner}
            />
          </View>
            {/* payment section */}
       ...
       <View style={{flexDirection:'row',justifyContent:'space-between',width:'95%',alignItems:'center'}}>
          <View style={{width:'70%'}}>
              <MyText
                text={`At purchase my BVC Salesperson advised me I could Rent out my timeshare: : `}
                textColor="#353334"
                fontSize={13}
                fontFamily="Verdana"
                textAlign="auto"
    ...
    {/* ************************* Defination  section******** */}         
              ...
              <MyText
                ...
                />
                <MyText
                  text={`Capitalized terms not defined herein shall have the same meaning as that given to them by Bluegreen Vacation Owners Exchange Procedures.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`Program Member hereby authorizes TS to act as its designated Delegate for the purposes of making reservations and operating PM’s account for the Number of Points Allocated by PM as set out in the Summary. PM shall provide any required notices to BVC. Program Member agrees to provide during the Term, PM’s login credentials to TS for the online reservation system and authorize TS to log in to and interact with BVC reservation or other personnel on behalf of Program Member. TS is also authorized by PM to answer any reservation questions, phone calls, certifications, or acknowledgments on behalf of Program Member in connection with any Guest reservation.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
               ...
               <MyText
                ...
                />
                 <MyText
                  text={`II. Program Member's BVC account is in good standing, and it has the authority to make Guest reservations;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                 <MyText
                  text={`III. Program Member has not received any notices from BVC that it is not otherwise permitted to offer Accommodations to an invited Guest;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`IV. Program Member is not engaged in any commercial use or purpose with respect to their BVC account;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
...
export default BlugreenContract;
