        ...
        /> */}
          ...
          <View>
            ...
            >
              ...
              <MyText
                text={"Bluegreen Vacation Club Member. This contract"}
                textColor="#353334"
                fontSize={13}
                fontFamily="Verdana"
          ...
          <MyText
            ...
            <MyText
              text={`Bluegreen Vacation Club Points -Use Year`}
              textColor="#353334"
              fontSize={13}
              fontFamily="Verdana"
              textAlign="auto"
...
{/* 88888888888888888 */}
          ...
          <View style={{ marginHorizontal: 10 }}>
           ...
           {isPaymentDetails ?
            ...
            />
            <MyText
              text={`Bluegreen Vacation Club Account:`}
              textColor="#000"
              fontSize={15}
              fontFamily="Verdana"
              textAlign="auto"
            ...
            />
            <MyText
              text={`Bluegreen Vacation Club Owner`}
              textColor="#353334"
              fontSize={13}
              fontFamily="Verdana"
              textAlign="auto"
