import {
  ...
  import {formatPhoneNumber, getImageForDeveloper, width} from '../../../global/Constant';
  ...
  const LawrenceContract = ({navigation, route}) => {
    ...
    return (
      <>
          ...
          /> */}
            ...
            <ImageBackground
             ...
             <View>
                    ...
                    <MyText
                      text={
                        'WHEREAS, Program Member owns a number of points in the Hyatt Vacation Club ("HVC")timeshare program and desires to engage TS to act as its designated Delate to operate PM’s timeshare program for the purposes including but not limited to, arranging, coordinating and identifying Guests to utilize PM’s HVC points; and'
                      }
                      textColor="#353334"
                      fontSize={13}
                      fontFamily="Verdana"
            ...
            <View style={{backgroundColor: '#F0DFCF'}}>
              <View style={{padding: 5}}>
                ...
                <View>
                  ...
                  <MyText
                    text={
                      'The owner must promptly notify us within 24 hours if they utilize any points from the agreed-upon total. This facilitates record updates and issuance of a revised contract to avoid confusion.'
                    }
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
                  ...
                  <View>
                    ...
                    <MyText
                      text={
                        'Damages will be covered by the insurance provided by the hosting platforms we use. However, in other situations, we cannot be held liable,although we will offer assistance to resolve any issues to the best of our ability.'
                      }
                      textColor="#353334"
                      fontSize={13}
                      fontFamily="Verdana"
                  ...
                  <MyText
                    text={
                      'However, they must promptly notify us if they utilize any points from the agreedupon total that they are under contract for guest reservations so we can send an updated contract.'
                    }
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
       ...
       <View style={{flexDirection:'row',justifyContent:'space-between',width:'95%',alignItems:'center'}}>
          <View style={{width:'70%'}}>
              <MyText
                text={`At purchase my HVC Salesperson advised me I could Rent out my timeshare: : `}
                textColor="#353334"
                fontSize={13}
                fontFamily="Verdana"
                textAlign="auto"
    ...
    {/* ************************* Defination  section******** */}         
              ...
              <MyText
                ...
                />
                <MyText
                  text={`Capitalized terms not defined herein shall have the same meaning as that given to them by Hyatt Vacation Owners Exchange Procedures.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`Program Member hereby authorizes TS to act as its designated Delegate for the purposes of making reservations and operating PM’s account for the Number of Points Allocated by PM as set out in the Summary. PM shall provide any required notices to HVC. Program Member agrees to provide during the Term, PM’s login credentials to TS for the online reservation system and authorize TS to log in to and interact with HVC reservation or other personnel on behalf of Program Member. TS is also authorized by PM to answer any reservation questions, phone calls, certifications, or acknowledgments on behalf of Program Member in connection with any Guest reservation.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                 <MyText
                  text={`For instance, if you are a Hyatt Vacation owner and have allocated 500,000 points to us, with an anniversary date from January 1 to December 31st, and we utilize 350,000 points by August 31st, we will carry forward the remaining 150,000 points into the following use year for bookings in that year which will automatically be deemed the Number of Points Allocated and the Payment Per Point Remains the same.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                 <MyText
                  text={`Please take note that it is subject for fees when you banking your points. And if we roll over your points to the next year to complete the guest reservations, we will subtract the amount we paid for the rollover fee to get your points into the applicable year`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
               ...
               <MyText
                ...
                />
                 <MyText
                  text={`II. Program Member's HVC account is in good standing, and it has the authority to make Guest reservations;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                 <MyText
                  text={`III. Program Member has not received any notices from HVC that it is not otherwise permitted to offer Accommodations to an invited Guest;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`IV. Program Member is not engaged in any commercial use or purpose with respect to their HVC account;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`This Agreement shall be governed by and construed in accordance with the laws of the State of Nevada. This Agreement represents the entire understanding between the Parties and supersedes all prior agreements and understandings, oral or written. Any modification to this Agreement must be in writing and signed by both Parties.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
...
{/* ********************end***************************** */}
  ...
  export default LawrenceContract;
