import {
  ...
  const StarwoodContract = ({navigation, route}) => {
            ...
            <View>
              ...
              <View>
                  <MyText
                    ...
                    fontFamily="Verdana"
                    textAlign={'auto'}
                    style={{marginLeft: 20, marginTop: 60, fontWeight: '700'}}
                  />
                  <MyText
                    text={
                      'WHEREAS, Program Member owns a number of points in the Starwood Vacation Ownership  ("SVO")  timeshare  program  and  desires  to  engage  TS  to  act  as  its  designated delegate to operate PM’s timeshare program for the purposes including but not limited to, arranging, coordinating and identifying Guests to utilize PM’s SVO points; and'
                    }
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
            ...
            <View style={{backgroundColor: '#F0DFCF'}}>
              <View style={{padding: 5}}>
                ...
                <View>
                  ...
                  <MyText
                    text={
                      'How ever, they must promptly notify if they utilize any points from the agreed upon total that they are under contract for guest reservations so we can send an updated contract.'
                    }
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
       ...
       <View style={{flexDirection:'row',justifyContent:'space-between',width:'95%',alignItems:'center'}}>
          <View style={{width:'70%'}}>
              ...
              <TouchableOpacity style={{width:20,height:20,borderRadius:2,borderColor:'#000',borderWidth:1,marginLeft:3,marginTop: 20,justifyContent:'center'}}
                 ...
                 {/* <Text style={{fontSize:10,color:'#353334',fontFamily:'Verdana',lineHeight:21,marginTop: 20, fontWeight: 400,textAlign:'center'}}>Yes</Text>
                   <TouchableOpacity style={{width:20,height:20,borderRadius:20,borderColor:'#000',borderWidth:1,marginLeft:3,marginTop: 20,justifyContent:'center'}}
                   onPress={()=>{
                    setmvc(true)
                    }}>
                    <View style={{width:'80%',height:'80%',borderRadius:20,backgroundColor:mvc?'#000':'#fff',alignSelf:'center'}}></View>
                   </TouchableOpacity>
                   <Text style={{fontSize:10,color:'#353334',fontFamily:'Verdana',lineHeight:21,marginTop: 20, fontWeight: 400,textAlign:'center',marginLeft:10}}>No</Text>
                   <TouchableOpacity style={{width:20,height:20,borderRadius:20,borderColor:'#000',borderWidth:1,marginLeft:3,marginTop: 20,justifyContent:'center'}}
                   onPress={()=>{
                    setmvc(false)
                    }}>
                    <View style={{width:'80%',height:'80%',borderRadius:20,backgroundColor:mvc?'#fff':'#000',alignSelf:'center'}}></View>
                   </TouchableOpacity> */}
              </View>
...
{/* 
            ...
            <View style={{marginHorizontal: 5}}>
              ...
              <MyText
                ...
                />
                <MyText
                  text={`Capitalized terms not defined herein shall have the same meaning as that given to them by Starwood Vacation Ownership Exchange Procedures.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`We will automatically carry forward the Number of Points Allocated into the following year on your behalf. The roll over date is set at 2 months prior to the deadline to rollover, unless you provide written notice to us at least 30 days prior to your rollover deadline.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                 <MyText
                  text={`For instance, if you are a Starwood Vacation owner and have allocated 200,000 points to us, with an anniversary date from November 1 to October 31st, and we utilize 150,000 points by August 31st, we will carry forward the remaining 50,000 points into the following use year for bookings in that year which will automatically be deemed the Number of Points Allocated and the Payment Per Point Remains the same.`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
               ...
               <MyText
                ...
                />
                <MyText
                  text={`II. Program Member's SVO account is in good standing, and it has the authority to make Guest reservations;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                 <MyText
                  text={`III. Program Member has not received any notices from SVO that it is not otherwise permitted to offer Accommodations to an invited Guest;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
                ...
                />
                <MyText
                  text={`IV. Program Member is not engaged in any commercial use or purpose with respect to their SVO account;`}
                  textColor="#353334"
                  fontSize={13}
                  fontFamily="Verdana"
                  textAlign="auto"
...
{/* ********************end***************************** */}
  ...
  export default StarwoodContract;
