        ...
        <ScrollView contentContainerStyle={{paddingBottom: '20%'}}>
          ...
          <View>
              ...
              <View>
                  ...
                  <MyText
                    text={
                      'WHEREAS, Program Member owns a number of points in the Marriott Vacation Club("MVC") timeshare program and desires to engage TS to act as its designated delegate to operate PM’s timeshare program for the purposes including but not limited to, arranging, coordinating and identifying Guests to utilize PM’s MVC points; and'
                    }
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
            ...
            <View style={{padding: 5}}>
              ...
              <View>
                ...
                <View>
                  ...
                  />
                  <MyText
                    text={'We reserve the right to utilize necessary channels to connect you with your guests.'}
                    textColor="#353334"
                    fontSize={13}
                    fontFamily="Verdana"
                    textAlign={'auto'}
...
export default MarriottContract;
