...
export const getImageForDeveloper = devname => {
  return devname == 'Bluegreen'
    ? ScreenNames.BLUEGREEN_CONTRACT
    : devname == 'Diamond Resorts'
    ? ScreenNames.DIMOND_CONTRACT
    : devname == 'Club Wyndham'
    ...
    ? ScreenNames.HOLYDAYIN_CONTRACT
    : devname == 'World Mark'
    ? ScreenNames.WORLDMARK_CONTRACT
    : devname == 'World Mark by Wyndham'
    ? ScreenNames.WORLDMARK_CONTRACT
    : devname == 'Marriot'
    ? ScreenNames.MARRIOT_CONTRACT
    : devname == 'Marriott'
    ? ScreenNames.MARRIOT_CONTRACT
    : devname == 'Starwood Club'
    ? ScreenNames.STARWOOD_CONTRACT
    : null
};
...
export const getFormattedPhoneNumber = num => {
  console.log('getFormattedNumber num', num);
  num = String(num);
  const firstThree = num.slice(0, 3);
  const secondThree = num.slice(3, 6);
...
export const getNameOfNumber = num => {
  if (num == 1) {
    return 'First';
  } else if (num == 2) {
    return 'Second';
